...
import 'package:auftrag_mobile/screens/settings/account/account_settings_screen.dart';
import 'package:auftrag_mobile/screens/settings/theme/theme_settings_screen.dart';
            ...
            if (state is AuthProfileLoaded) {
              return ListView(
                ...
                children: <Widget>[
                  ...
                  settingsListTile(context, 'Konto', onTap: () {
                  ...
                  SizedBox(height: 15.0),
                  settingsListTile(context, 'Thema', onTap: () {
                    Navigator.of(context).push(
                      MaterialPageRoute(
